...
interface MainAddTeamMemberProps {
  createTeamMemberAction: (data: CreateTeamMemberInput) => Promise<CreateTeamMemberResponse>;
}

const MainAddTeamMember = ({ createTeamMemberAction }: MainAddTeamMemberProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Send to server
      const result = await createTeamMemberAction(teamMemberData);
      ...
      if (result.success) {
        ...
        // Redirect to team members list after 1.5 seconds
        setTimeout(() => {
...
export default MainAddTeamMember;
